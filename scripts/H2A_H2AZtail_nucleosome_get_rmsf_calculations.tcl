...
mol addfile H2A_H2AZtail_nucleosome_initial.gro 
mol addfile H2A_H2AZtail_nucleosome_overal_2us_long_final.trr step 1 
mol addfile H2A_H2AZtail_nucleosome_average.gro 
...
set outfile [open "H2A_H2AZtail_nucleosome_get_rmsf_calculations.dat"  w]
