...
mol addfile H2AZ_resrtaint_nucleosome_initial.gro 
mol addfile H2AZ_resrtaint_nucleosome__overal_2us_long_final.pdb.trr step 1 
mol addfile H2AZ_resrtaint_nucleosome_average.gro 
...
set outfile [open "H2AZ_resrtaint_nucleosome_get_rmsf_calculations.dat"  w]
