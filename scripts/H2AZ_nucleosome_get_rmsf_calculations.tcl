...
mol addfile H2AZ_nucleosome_initial.gro 
mol addfile H2AZ_nucleosome_overal_7us_long_final.trr step 1 
mol addfile H2AZ_nucleosome_average.gro 
...
set outfile [open "H2AZ_nucleosome_get_rmsf_calculations.dat"  w]
