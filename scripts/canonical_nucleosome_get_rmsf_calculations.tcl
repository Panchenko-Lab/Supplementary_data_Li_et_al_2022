...
mol addfile canonical_nucleosome_initial.gro 
mol addfile canonical_nucleosome_overal_7us_long_final.trr step 1 
mol addfile canonical_nucleosome_average.gro 

set nframes [expr  [molinfo top get numframes] - 1 ]
set all [atomselect top "all"]
set rmsf [measure rmsf $all first 2001 last 70000]
...
set outfile [open "canonical_nucleosome_get_rmsf_calculations.dat"  w]
